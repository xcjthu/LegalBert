...
class LongformerLayer(nn.Module):
    ...
    def forward(
        ...
        if self.layer_id >= 8:
            layer_output[:,1::2] = hidden_states[:,1::2]
...
class TokenSkipLFM(LongformerPreTrainedModel):
    """
...
class TokenSkipLFMForMaskedLM(LongformerPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.longformer = TokenSkipLFM(config, add_pooling_layer=False)
