...
from model.LongformerSentID.HierDisLFM import HiDisLFMForMaskedLM

class HierDisLFM(nn.Module):
    def __init__(self, config, gpu_list, *args, **params):
        super(HierDisLFM, self).__init__()
        ...
        self.LFM = HiDisLFMForMaskedLM.from_pretrained("thunlp/Lawformer")
