...
class BertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        vocab_size=30522,
        hidden_size=768,
        hidden_size_layerwise=[768, 768, 768, 512, 512, 256, 256, 512, 512, 768, 768, 768],
        num_hidden_layers=12,
        num_attention_heads=12,
        num_attention_heads_layerwise=[12, 12, 12, 8, 8, 4, 4, 8, 8, 12, 12, 12],
        ...
        **kwargs
        ...
        self.hidden_size_layerwise = hidden_size_layerwise
        self.num_attention_heads_layerwise = num_attention_heads_layerwise
