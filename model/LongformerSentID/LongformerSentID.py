...
class LongformerSentIDModel(LongformerPreTrainedModel):
    """
...
class LongformerSentIDForMaskedLM(LongformerPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.longformer = LongformerSentIDModel(config, add_pooling_layer=False)
